...
const page: FC = () => {
    ...
    return (
        <main className="min-h-screen pt-32 max-w-7xl mx-auto px-8 relative z-20">
            ...
            <section className="pb-16">
                ...
                <p>
                    Agencja WebNova nie ponosi odpowiedzialności za ewentualne
                    szkody wynikłe z korzystania z naszej strony internetowej.
                </p>
