        ...
        <section className="my-20 lg:my-28 padding-x">
            <div className="max-w-7xl w-full flex flex-col mx-auto md:flex-row gap-10 ">
                <section className="flex flex-col w-full max-w-lg lg:max-w-2xl gap-4">
                    <h1
                        className={`font-bold text-4xl lg:text-5xl leading-snug`}
                    >
                        Cześć, <br />
                        Jestem Dawid. <br />
                    ...
                    <h2 className="my-4">
                        Stworzę dla Ciebie nowoczesną i profesjonalną stronę
                        internetową która pozwoli Ci wyrazić swoją markę i
                        dotrzeć do swoich klientów. Moje projekty są dopracowane
                        w każdym detalu i dostosowane do Twoich potrzeb.
                        Skontaktuj się ze mną już dziś, aby dowiedzieć się, jak
                        mogę pomóc Ci wzmocnić Twoją pozycję w internecie i
