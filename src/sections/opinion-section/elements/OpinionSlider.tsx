...
const opinions = [
    ...
    {
        author: "Kamila Jaśkowska",
        opinion:
            "Profesjonalna strona internetowa, która przyciąga klientów i wyróżnia nasz salon kosmetyczny. Dzięki współpracy strona regularnie przynosi nam nowych klientów. Dziękuję za świetną pracę!",
    },
    {
        author: "Rafał - Rckart",
        opinion:
            "Jestem bardzo zadowolony ze współpracy! Komunikacja była bezproblemowa a odpowiedzi na pytania natychmiastowe. Po zakończeniu projektu zostałem przeszkolony z panelu administratora. Strona wygląda i działa świetnie a do tego od samego początku przynosi nowych klientów. Zdecydowanie polecam!",
    },
];
