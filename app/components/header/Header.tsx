...
const Header: FC = () => {
    return (
        <header className="w-full z-10 fixed flex flex-col top-0 left-0 backdrop-blur-lg padding-x py-4 h-16 lg:py-5 lg:bg-inherit lg:m-auto lg:h-20 lg:flex-row">
